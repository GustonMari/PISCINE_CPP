...
/*   Updated: 2022/04/28 10:17:08 by gmary            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap(std::string new_name): name(new_name + "_clap_name")
{
...
DiamondTrap::DiamondTrap(const DiamondTrap & src): ClapTrap(src), ScavTrap(src), 
{
	*this = src;
}
